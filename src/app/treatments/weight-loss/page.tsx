        ...
        <div className="min-h-screen bg-[white] text-[#102A52] selection:bg-[#a10c22]/30">
            ...
            <section className="pt-40 pb-20 px-6 container mx-auto">
                <div className="max-w-4xl mx-auto text-center">
                    <span className="text-[#a10c22] text-xs font-bold tracking-[0.2em] uppercase mb-6 block">GLP-1/GIP Receptor Agonists</span>
                ...
                <div className="container mx-auto px-6 max-w-5xl">
                    <div className="grid md:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="space-y-8">
                            <h2 className="text-4xl font-serif text-[#102A52]">How Our Customized GLP-1 Protocol Transforms Your Metabolism</h2>
